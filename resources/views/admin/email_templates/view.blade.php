		...
		<div class="content-wrapper">
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body"> 
						<form action="{{url('admin/update_email_template')}}" name="update_profile">
		...
		<div class="col-md-12">
			<fieldset>
				<div class="form-group row">
					...
					<div class="col-lg-8">
						<input type="text" name="category_name" class="form-control" value="{{$email_templates->category_name}}">
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-lg-8">
						<input type="text" name="subject" class="form-control" value="{{$email_templates->subject}}">
					</div>
				</div>

				<div class="form-group row">
					<label class="col-lg-3 col-form-label">Mail Body:</label>
					<div class="col-lg-8">
						<textarea name="mail_body" id="editor-full" rows="4" cols="4">
								{{$email_templates->mail_body}}	
						</textarea>
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-lg-8">
						<select class="form-control" name="status">                   
	                        <option value="1" <?=$email_templates->status == 1 ? ' selected="selected"' : '';?>>Active</option>
	                        <option value="0" <?=$email_templates->status == 0 ? ' selected="selected"' : '';?>>Deative</option>
