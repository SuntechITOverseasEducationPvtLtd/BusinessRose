			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Investors</span></h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="datatable_responsive.html" class="breadcrumb-item">Investors</a>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Manage Investor Profiles</h5>
							...
							<tr>
								...
								<td>
									<div class="list-icons">							
										...
										<a href="{{url('admin/delete_investor',$user->user_id)}}" onclick="return confirm('Are you sure you want to delete ?')" class="list-icons-item">&nbsp;&nbsp;<i class="icon-trash text-primary-600"></i>Delete</a>
										<a href="{{url('admin/block_investor',$user->user_id)}}" onclick="return confirm('Are you sure you want to block ?')" class="list-icons-item">&nbsp;<i class="icon-blocked text-danger-600"></i>Block</a>
									</div>									
								</td>
