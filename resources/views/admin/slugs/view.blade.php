		...
		<div class="content-wrapper">
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body"> 
						<form action="{{url('admin/update_slug')}}" name="update_profile">
			<input type="hidden" name="id" value="{{$slugs->id}}">
							<div class="row">
		...
		<div class="col-md-12">
			<fieldset>
				<div class="form-group row">
					...
					<div class="col-lg-8">
						<input type="text" name="page_name" class="form-control" value="{{$slugs->page_name}}">
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-lg-8">
						<input type="text" name="meta_keyword" class="form-control" value="{{$slugs->meta_keyword}}">
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-lg-8">
						<input type="text" name="meta_description" class="form-control" value="{{$slugs->meta_description}}">
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-lg-8">
						<textarea name="page_content" id="editor-full" rows="4" cols="4">
								{{$slugs->page_content}}	
						</textarea>
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-lg-8">
						<select class="form-control" name="status">                   
	                        <option value="1" <?=$slugs->status == 1 ? ' selected="selected"' : '';?>>Active</option>
	                        <option value="0" <?=$slugs->status == 0 ? ' selected="selected"' : '';?>>Deative</option>
