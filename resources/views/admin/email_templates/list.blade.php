			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Manage Email Templates</h5>
					...
					<table class="table datatable-responsive">
						...
						<tbody>
							<?php $i=1; foreach($email_templates as $row) { ?>
							<tr>
								<td>{{$i}}</td>
								...
								<td class="text-center">
									<a href="{{url('admin/edit_email_template',$row->id)}}" class="list-icons-item">&nbsp;<i class="icon-pencil7  text-violet-600"></i>Edit</a>
								</td>
							</tr>
						<?php $i++; } ?>
