			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Startup Skilled Persons Lists</h5>
					...
					<table class="table datatable-responsive">
						...
						<tbody>
							...
							<tr>
								...
								<td><span class="badge badge-success"><a href="{{url('admin/activate_startupSkilledPerson',$user->user_id)}}" style="color:#fff;">{{'Approve'}}</a></span></td>
								<td><span class="badge badge-danger"><a href="{{url('admin/deactivate_startupSkilledPerson',$user->user_id)}}" style="color:#fff;">{{'Deny'}}</a></span></td>
								<td><a href="{{url('admin/startupSkilledPerson_profile_view',$user->user_id)}}" class="btn bg-transparent border-indigo-400 text-indigo-400 rounded-round border-2 btn-icon"><i class="icon-eye"></i></a></td>
							</tr>
							<?php $i++; } ?>
