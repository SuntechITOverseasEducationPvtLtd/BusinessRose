		...
		<div class="content-wrapper">
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body"> 
						<form action="{{url('admin/update_subscription')}}" name="update_profile">
		...
		<div class="col-md-8">
			<fieldset>
				<div class="form-group row">
					...
					<div class="col-lg-8">
						<input type="text" name="title" class="form-control" value="{{$subscriptions->title}}">
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-lg-8">
						<input type="text" name="price" class="form-control" value="{{$subscriptions->price}}">
					</div>
				</div>

				<div class="form-group row">
					<label class="col-lg-4 col-form-label">Credits:</label>
					<div class="col-lg-8">
						<input type="text" name="credits" class="form-control" value="{{$subscriptions->credits}}">
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-lg-8">
						<input type="text" name="discount" class="form-control" value="{{$subscriptions->discount}}">
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-lg-8">
						<textarea rows="5" cols="8" class="form-control" name="description">{{$subscriptions->description}}</textarea>
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-lg-8">
						<select class="form-control" name="status">                   
	                        <option value="1" <?=$subscriptions->status == 1 ? ' selected="selected"' : '';?>>Active</option>
	                        <option value="0" <?=$subscriptions->status == 0 ? ' selected="selected"' : '';?>>Deative</option>
