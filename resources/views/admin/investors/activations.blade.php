			...
			<div class="content">
				...
				<div class="card" >
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Investors Lists</h5>
						...
						<table class="table datatable-responsive">
							...
							<tbody>
								...
								<tr>
									...
									<td><span class="badge badge-success"><a href="{{url('admin/activate_investor',$user->user_id)}}" style="color:#fff;">{{'Approve'}}</a></span></td>
